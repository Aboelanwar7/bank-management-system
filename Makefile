...
LIB_LIST += -L/src/lib -lsfml-graphics -lsfml-window -lsfml-system -lopengl32 -lfreetype -lwinmm -lgdi32
#CXX flags
CXX_FLAGS := -c
#CXX_FLAGS += -w

build:
	@g++ $(CPP_FILES) -o main.exe -DSFML_STATIC $(LIB_LIST) -Isrc/include
run:
	@./main.exe